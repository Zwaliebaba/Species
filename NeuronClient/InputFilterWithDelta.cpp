...
#include "InputFilterWithDelta.h"
...
InputDetails const& InputFilterWithDelta::getOldDetails(InputFilterSpec const& spec) const { return getOldDetails(spec.id); }
...
InputDetails const& InputFilterWithDelta::getDetails(InputFilterSpec const& spec) const { return getDetails(spec.id); }
