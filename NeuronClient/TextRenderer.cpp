        ...
        for (int x = -1; x <= 1; ++x)
        {
          for (int y = -1; y <= 1; ++y)
          {
            if (x != 0 || y != 0)
            {
              ...
              glTexCoord2f(texX + TEX_WIDTH, texY + TEX_HEIGHT);
              glVertex2f(_x + x + _size, _y + y + horiSize);
              glTexCoord2f(texX + TEX_WIDTH, texY);
              glVertex2f(_x + x, _y + y + horiSize);
              glTexCoord2f(texX, texY);
        ...
        for (int x = -1; x <= 1; ++x)
        {
          for (int y = -1; y <= 1; ++y)
          {
            if (x != 0 || y != 0)
            {
              ...
              glVertex2f(_x + x, _y + y);
              glTexCoord2f(texX + TEX_WIDTH, texY + TEX_HEIGHT);
              glVertex2f(_x + x + horiSize, _y + y);
              glTexCoord2f(texX + TEX_WIDTH, texY);
              glVertex2f(_x + x + horiSize, _y + y + _size);
              glTexCoord2f(texX, texY);
              glVertex2f(_x + x, _y + y + _size);
              glEnd();
            }
          }
        }
