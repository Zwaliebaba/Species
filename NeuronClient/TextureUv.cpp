...
namespace Neuron
{
  ...
  // *** Operator +
  TextureUV TextureUV::operator+(TextureUV const& _b) const { return TextureUV(u + _b.u, v + _b.v); }
  ...
  // *** Operator *
  TextureUV TextureUV::operator*(float const _b) const { return TextureUV(u * _b, v * _b); }
