...
namespace Neuron
{
  ...
  RGBAColour BitmapRGBA::GetInterpolatedPixel(float _x, float _y) const
  {
    ...
    RGBAColour returnVal(static_cast<float>(c11.r) * weight11 + static_cast<float>(c12.r) * weight12 + static_cast<float>(c21.r) * weight21 +
                           static_cast<float>(c22.r) * weight22,
                         static_cast<float>(c11.g) * weight11 + static_cast<float>(c12.g) * weight12 + static_cast<float>(c21.g) * weight21 +
                           static_cast<float>(c22.g) * weight22,
                         static_cast<float>(c11.b) * weight11 + static_cast<float>(c12.b) * weight12 + static_cast<float>(c21.b) * weight21 +
                           static_cast<float>(c22.b) * weight22,
                         static_cast<float>(c11.a) * weight11 + static_cast<float>(c12.a) * weight12 + static_cast<float>(c21.a) * weight21 +
                           static_cast<float>(c22.a) * weight22);
