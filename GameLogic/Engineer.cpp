...
namespace Species
{
  ...
  bool Engineer::AdvanceToTargetPos()
  {
    ...
    if (distanceLength > 5.0f)
    {
      ...
      DirectX::XMVECTOR const velocity = DirectX::XMVectorScale(
        DirectX::XMVectorSubtract(DirectX::XMLoadFloat3(&m_pos), DirectX::XMLoadFloat3(&oldPos)), 1.0f / SERVER_ADVANCE_PERIOD);
  ...
  bool Engineer::AdvanceResearching()
  {
    ...
    for (int i = 0; i < 2; ++i)
    {
      ...
      DirectX::XMStoreFloat3(&particleVel,
                             DirectX::XMVectorAdd(DirectX::XMVectorSubtract(DirectX::XMLoadFloat3(&m_pos), DirectX::XMLoadFloat3(&toPos)),
    ...
    DirectX::XMStoreFloat3(&m_pos,
                           DirectX::XMVectorMultiplyAdd(DirectX::XMLoadFloat3(&m_pos), DirectX::XMVectorReplicate(1.0f - SERVER_ADVANCE_PERIOD),
