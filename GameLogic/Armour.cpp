...
//#endif
    ...
    switch( m_state )
    {
        case StateIdle :        m_flag.SetTexture( g_app->m_resource->GetTexture( "Icons/BannerNone.bmp" ) );              break;
        case StateUnloading :   m_flag.SetTexture( g_app->m_resource->GetTexture( "Icons/BannerUnload.bmp" ) );            break;
        case StateLoading :     m_flag.SetTexture( g_app->m_resource->GetTexture( "Icons/BannerFollow.bmp" ) );            break;
    }
