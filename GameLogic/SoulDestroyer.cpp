...
namespace Species
{
  ...
  // position row alone.
  static DirectX::XMFLOAT4X4 XM_CALLCONV ScaledTailBasis(DirectX::FXMVECTOR _front, DirectX::FXMVECTOR _up, DirectX::FXMVECTOR _position,
                                                         float _scale)
  {
  ...
  bool SoulDestroyer::AdvanceToTargetPosition()
  {
    ...
    DirectX::XMStoreFloat3(&m_vel,
                           DirectX::XMVectorScale(DirectX::XMVectorSubtract(DirectX::XMLoadFloat3(&m_pos), old), 1.0f / SERVER_ADVANCE_PERIOD));
