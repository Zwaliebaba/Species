...
bool Tree::DoesSphereHit(const Vector3& _pos, float _radius)
{
...
bool Tree::DoesRayHit(const Vector3& _rayStart, const Vector3& _rayDir, float _rayLen, Vector3* _pos, Vector3* _norm)
{
