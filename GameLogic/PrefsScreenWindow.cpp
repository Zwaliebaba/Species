...
class SetScreenButton : public SpeciesButton
{
    void MouseUp()
    {
      ...
      parent->m_resId =
        g_windowManager->GetResolutionId(g_prefsManager->GetInt(SCREEN_WIDTH_PREFS_NAME), g_prefsManager->GetInt(SCREEN_HEIGHT_PREFS_NAME));
  ...
  : SpeciesWindow(LANGUAGEPHRASE("dialog_screenoptions"))
{
  ...
  m_resId = g_windowManager->GetResolutionId(g_prefsManager->GetInt(SCREEN_WIDTH_PREFS_NAME), g_prefsManager->GetInt(SCREEN_HEIGHT_PREFS_NAME));
