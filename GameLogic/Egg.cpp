  ...
  void Egg::Render(float predictionTime)
  {
    ...
    if (!m_dead)
    {
      ...
      if (m_state == StateFertilised)
      {
        ...
        glTexCoord2i(0, 0);
        EmitVertex(
          DirectX::XMVectorSubtract(DirectX::XMVectorSubtract(posVec, DirectX::XMVectorScale(right, size)), DirectX::XMVectorScale(up, size)));
        glTexCoord2i(0, 1);
        EmitVertex(DirectX::XMVectorAdd(DirectX::XMVectorSubtract(posVec, DirectX::XMVectorScale(right, size)), DirectX::XMVectorScale(up, size)));
        glTexCoord2i(1, 1);
        EmitVertex(DirectX::XMVectorAdd(DirectX::XMVectorAdd(posVec, DirectX::XMVectorScale(right, size)), DirectX::XMVectorScale(up, size)));
    ...
    else
    {
      ...
      for (int i = 0; i < 3; ++i)
      {
        ...
        EmitVertex(DirectX::XMVectorSubtract(DirectX::XMVectorSubtract(fragmentPosVec, DirectX::XMVectorScale(right, size)),
                                             DirectX::XMVectorScale(up, size)));
        glEnd();
      }
    }
