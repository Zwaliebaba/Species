...
namespace Species
{
  ...
  bool SporeGenerator::AdvanceToTargetPosition()
  {
    ...
    DirectX::XMVECTOR const targetVel = NearlyEquals(distanceToTarget, 0.0f) ? DirectX::XMVectorSet(speed, 0.0f, 0.0f, 0.0f)
                                                                             : DirectX::XMVectorScale(toTarget, speed / distanceToTarget);
