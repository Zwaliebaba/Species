...
class Matrix34
{
  public:
    ...
    Matrix34(Matrix34 const& _other) { memcpy(this, &_other, sizeof(Matrix34)); }
...
{
  return Vector3(m.r.x * v.x + m.u.x * v.y + m.f.x * v.z + m.pos.x, m.r.y * v.x + m.u.y * v.y + m.f.y * v.z + m.pos.y,
